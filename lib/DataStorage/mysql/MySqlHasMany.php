<?php
	...
	class MySqlHasMany extends MySqlRelationship{
		...
		public function joinStatement($obj){
			...
			return sprintf("left join %s on %s.%s=%s.%s", $tableName, $tableName, (is_array($this->through) ? $this->through[1] : $this->through), $joinToTableName, (is_array($this->through) ? $this->through[0] : $this->through));
		}
	}
?>